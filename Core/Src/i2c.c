...
//
//static I2C_HandleTypeDef* hal_i2c_get_peripheral(void);
...
//static void hal_i2c_peripheral_write_data_register(volatile uint32_t data_register_value);
...
//static uint32_t hal_i2c_read_control_register_bit(uint32_t control_register_bit);
...
//static void hal_i2c_set_peripheral_transfer_parameters(uint8_t *data_buffer_pointer, uint16_t size, volatile uint32_t transfer_options);
