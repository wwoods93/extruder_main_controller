...
class i2c : public resource
{
    public:
        ...
        /* macros */
        #define I2C_ENABLE_MODULE(__HANDLE__)           (__HANDLE__)->instance->CONTROL_REG_1 |= I2C_CR1_MODULE_ENABLE
        #define I2C_DISABLE_MODULE(__HANDLE__)          (__HANDLE__)->instance->CONTROL_REG_1 &= (~I2C_CR1_MODULE_ENABLE)
