...
class rtd
{
    ...
    private:
        ...
        uint32_t temperature_celsius_float_component = 0U;
        uint16_t temperature_celsius_integer_component = 0U;
        uint16_t next_resistance_in_lookup_table = 0U;
        uint16_t temperature_range_min = 0U;
