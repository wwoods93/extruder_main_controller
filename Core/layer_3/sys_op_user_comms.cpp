...
hal::timer_handle_t* device::band_heater::zero_crossing_pulse_timer_module = hal::tim_1_get_handle();
    ...
    void task_state_machine()
    {
        ...
        switch (comms_handler_state)
        {
            case USER_COMMS_INIT:
            {
                ...
                comms_handler_output_data_queue_handle  = rtosal::user_comms_queue_get_handle();
                ...
                hal::i2c_register_callback(i2c_2_get_handle(), hal::I2C_CONTROLLER_TX_COMPLETE_CALLBACK_ID, hal_callback_i2c_controller_tx_complete);
                hal::i2c_register_callback(i2c_2_get_handle(), hal::I2C_ERROR_CALLBACK_ID, hal_callback_i2c_controller_error);

                device::debug_serial_monitor.initialize(usart_2_get_handle(), serial_monitor_usart_queue_handle);
                device::built_in_display.initialize(i2c_2_get_handle(), comms_handler_output_data_queue_handle);
